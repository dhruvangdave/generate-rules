...
<template>
    <div slot="cache-commands">
        ...
        <div class="p-3 d-flex" style="gap: 1rem;">
            <button class="btn btn-primary text-center" :disabled="isAnyLoading" title="Model Prune"
                    @click.prevent="modelPrune">
                    <span v-if="loadingPrune" class="icon spin fill-text-color">
                ...
                <span v-else>Model Prune</span>
            </button>
            <button class="btn btn-primary text-center" :disabled="true" title="Model Show"
                    @click.prevent="modelShow">
