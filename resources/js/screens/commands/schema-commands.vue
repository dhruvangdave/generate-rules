...
<template>
    <div slot="cache-commands">
        ...
        <div class="p-3 d-flex" style="gap: 1rem;">
            <button class="btn btn-primary text-center" :disabled="true" title="Schema Dump"
                    @click.prevent="schemaDump">
                    <span v-if="loadingDump" class="icon spin fill-text-color">
