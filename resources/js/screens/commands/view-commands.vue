...
<template>
    <div slot="cache-commands">
        ...
        <div class="p-3 d-flex" style="gap: 1rem;">
            <button class="btn btn-primary text-center" :disabled="isAnyLoading" title="View Cache"
                    @click.prevent="viewCache">
                ...
                <span v-else>View Cache</span>
            </button>
            <button class="btn btn-primary text-center" :disabled="isAnyLoading" title="View Clear"
                    @click.prevent="viewClear">
