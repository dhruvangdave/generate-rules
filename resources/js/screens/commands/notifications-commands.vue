...
<template>
    <div slot="cache-commands">
        ...
        <div class="p-3 d-flex" style="gap: 1rem;">
            <button class="btn btn-primary text-center" :disabled="isAnyLoading" title="Notifications Table"
                    @click.prevent="notificationsTable">
                ...
                <span v-else>Notifications Table</span>
            </button>
        </div>
    </div>
</template>
