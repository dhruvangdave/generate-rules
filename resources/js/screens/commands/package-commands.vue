...
<template>
    <div slot="cache-commands">
        <h6 class="px-3 pt-3 mb-0 text-sm">Package Commands</h6>
        <div class="p-3 d-flex" style="gap: 1rem;">
            <button class="btn btn-primary text-center" :disabled="isAnyLoading" title="Package Discover"
                    @click.prevent="packageDiscover">
                    <span v-if="loadingDiscover" class="icon spin fill-text-color">
                ...
                <span v-else>Package Discover</span>
            </button>
        </div>
    </div>
</template>
