...
export default {
     ...
     */
    mounted() {
        document.title = this.title + " - GenerateRules";
    ...
    methods: {
        loadEntries(after) {
            axios.post(Telescope.basePath + '/generate-rules-api/' + this.resource +
                '?tag=' + this.tag +
...
<template>
    <div class="card overflow-hidden">
        ...
        <div id="indexScreen" class="table table-hover mb-0 penultimate-column-right" v-if="ready">
            <hr class="p-0 m-0"/>
