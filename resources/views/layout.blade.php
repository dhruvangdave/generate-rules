...
<head>
    ...
    <link href="{{ asset(mix($cssFile, 'vendor/generateRules')) }}" rel="stylesheet" type="text/css">
</head>
<body>
    ...
    <div class="container mb-5">
        <div class="d-flex align-items-stretch py-4 header">
            <router-link to="/" class="logo d-flex align-items-center">
                ...
                <h4 class="mb-0 ml-3"><strong>Laravel</strong> GenerateRules{{ config('app.name') ? ' - ' . config('app.name') : '' }}</h4>
            </router-link>
...
{{--                    </li>--}}
                    ...
                    <li class="nav-item">
                        <router-link active-class="active" to="/rule-generator" class="nav-link d-flex align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#3498db">
                                <path fill-rule="evenodd" d="M3.25 3A2.25 2.25 0 001 5.25v9.5A2.25 2.25 0 003.25 17h13.5A2.25 2.25 0 0019 14.75v-9.5A2.25 2.25 0 0016.75 3H3.25zm.943 8.752a.75.75 0 01.055-1.06L6.128 9l-1.88-1.693a.75.75 0 111.004-1.114l2.5 2.25a.75.75 0 010 1.114l-2.5 2.25a.75.75 0 01-1.06-.055zM9.75 10.25a.75.75 0 000 1.5h2.5a.75.75 0 000-1.5h-2.5z" clip-rule="evenodd" />
                            </svg>
                            <span>Rules Generator</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/relations-generator" class="nav-link d-flex align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm.75-13a.75.75 0 00-1.5 0v5c0 .414.336.75.75.75h4a.75.75 0 000-1.5h-3.25V5z" clip-rule="evenodd" />
                            </svg>
                            <span>Relations Generator</span>
                        </router-link>
                    </li>
{{--                    <li class="nav-item">--}}
...
<script src="{{ asset(mix('app.js', 'vendor/generateRules')) }}"></script>
</body>
</html>
